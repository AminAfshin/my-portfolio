...
> This is my Portfolio Project. It is based on how to build my portfolio and make it responsive to various devices
...
```sh
  cd my-folder
  git clone https://github.com/AminAfshin/my-portfolio
```
-
...
## 👥 Author <a name="authors">Amin Afshin</a>

👤 **Amin Sfshin**

- GitHub: [@AminAfshin](https://github.com/AminAfshin)
...
If you like this project or would love to tell me ways to improve it, contact me on eamil. It will be a pleasure to hear from you and maybe collaborate on more projects.
...
I would like to thank KPU community for this opportunity to learn new things.
